...
<div class="cart-toggler">
	<a href="<?php echo wc_get_cart_url(); ?>"> 
		...
		<span class="cart-title"><?php esc_html_e('My cart', 'furnilife');?></span>
		<span class="cart-total"><?php echo WC()->cart->get_cart_subtotal(); ?></span> 
		<span class="cart-quantity">
			<?php echo sprintf(_n('%d item', '%d items', $woocommerce->cart->cart_contents_count, 'furnilife'), $woocommerce->cart->cart_contents_count);?>
		</span> 
	</a> 
</div> 
<div class="mini_cart_content">
	<div class="mini_cart_inner">
		...
		<?php if ( ! WC()->cart->is_empty() ) : ?>
			...
			<p class="woocommerce-mini-cart__total total"><strong><?php _e( 'Subtotal', 'furnilife' ); ?>:</strong> <?php echo WC()->cart->get_cart_subtotal(); ?></p>
		...
		<?php else : ?>
			...
			<p class="woocommerce-mini-cart__empty-message"><?php _e( 'No products in the cart.', 'furnilife' ); ?></p>
