...
//Shortcodes
add_shortcode( 'roadlogo', 'furnilife_logo_shortcode' );
add_shortcode( 'roadmainmenu', 'furnilife_mainmenu_shortcode' );
add_shortcode( 'roadcategoriesmenu', 'furnilife_roadcategoriesmenu_shortcode' );
add_shortcode( 'roadlangswitch', 'furnilife_roadlangswitch_shortcode' );
add_shortcode( 'roadsocialicons', 'furnilife_roadsocialicons_shortcode' );
add_shortcode( 'roadminicart', 'furnilife_roadminicart_shortcode' );
add_shortcode( 'roadproductssearch', 'furnilife_roadproductssearch_shortcode' );
add_shortcode( 'roadcopyright', 'furnilife_roadcopyright_shortcode' );
add_shortcode( 'ourbrands', 'furnilife_brands_shortcode' );
add_shortcode( 'furnilife_counter', 'furnilife_counter_shortcode' ); 
add_shortcode( 'categoriescarousel', 'furnilife_categoriescarousel_shortcode' );
add_shortcode( 'latestposts', 'furnilife_latestposts_shortcode' );
add_shortcode( 'furnilife_map', 'furnilife_contact_map' ); 

function furnilife_blog_sharing() {
    global $post;
    ...
    <div class="widget widget_socialsharing_widget">
        <h3 class="widget-title"><?php if(isset($furnilife_opt['blog_share_title'])) { echo esc_html($furnilife_opt['blog_share_title']); } else { esc_html_e('Share this post', 'furnilife'); } ?></h3>
...
function furnilife_product_sharing() {
    $furnilife_opt = get_option( 'furnilife_opt' );
    ...
    ?>
    <div class="widget widget_socialsharing_widget">
        <h3 class="widget-title"><?php if(isset($furnilife_opt['product_share_title'])) { echo esc_html($furnilife_opt['product_share_title']); } else { esc_html_e('Share this product', 'furnilife'); } ?></h3>
        <ul class="social-icons">
            <li><a class="facebook social-icon" href="#" onclick="javascript: window.open('<?php echo 'https://www.facebook.com/sharer/sharer.php?u='.$share_url; ?>'); return false;" title="Facebook" target="_blank"><i class="fa fa-facebook"></i></a></li>
            <li><a class="twitter social-icon" href="#" title="Twitter" onclick="javascript: window.open('<?php echo 'https://twitter.com/home?status='.$posttitle.'&nbsp;'.$share_url; ?>'); return false;" target="_blank"><i class="fa fa-twitter"></i></a></li>
            <li><a class="pinterest social-icon" href="#" onclick="javascript: window.open('<?php echo 'https://pinterest.com/pin/create/button/?url='.$share_url.'&amp;media='.$postimg.'&amp;description='.$posttitle; ?>'); return false;" title="Pinterest" target="_blank"><i class="fa fa-pinterest"></i></a></li>
